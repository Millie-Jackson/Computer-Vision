# scripts/rock_paper_scissors.py
        ...
        if turnTimer is False:
            ...
            if timer > 3:
                ...
                if hands:
                    ...
                    imgAI = cv2.imread(f'resources/{aiMove.lower()}.png', cv2.IMREAD_UNCHANGED)
                    ...
                    if imgAI is not None: 
                        ...
                        print(f"Error: Image resources/{aiMove.lower()}.png could not be loaded")
